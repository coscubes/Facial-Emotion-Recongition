...
def normalize_vector(landmark):
	temp = []
	for i in landmark:
		temp.append(euclidean(i, landmark[34]))
...
for i in images:
	...
	temp = get_landmarks(img)
	
	if temp == "error":
		print i
	else:
		feature_normal.append(normalize_vector(temp))
	labels.append(i[3:5])
...
print "Classifiers applied for facial landmarks preprocessing data\n"
print "\n Adaboost Classifier"
